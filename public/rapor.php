  ...
  $sectionRenderers = [
      ...
      <div class="rapor-section">
        ...
        <table class="t-print">
          ...
          <?php
            ...
            <tr><td colspan="5" style="background:#eef; font-weight:600"><?= esc($catNama) ?></td></tr>
        ...
        <div style="margin-top:6px; font-size:11px; color:#444">
          <strong>Final Score (Σ SPK)</strong> for each subject is the combined average of
    ...
    'extracurricular' => function() use ($ekskul) { ?>
      <div class="rapor-section">
        ...
        <?php if (!$ekskul): ?>
          <div style="font-size:12px; color:#666">No extracurricular grades have been recorded.</div>
        <?php else: ?>
